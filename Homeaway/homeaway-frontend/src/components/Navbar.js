            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                <ul className="navbar-nav ml-auto">
                    ...
                    (<li className="nav-item dropdown">
                        ...
                        <div className="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a className="dropdown-item" ><Link to={"/Dashboard/profile/" + cookie.load("userid")}>Dashboard</Link></a>
                    ...
                    (<li className="nav-item dropdown">
                        ...
                        <div className="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a className="dropdown-item" ><Link to={"/OwnerDashboard/profile/" + cookie.load("userid")}>Dashboard</Link></a>
                            <a className="dropdown-item" ><Link to="/" onClick={this.logout}>Logout</Link></a>
                        </div>
                    </li>)
                    }
